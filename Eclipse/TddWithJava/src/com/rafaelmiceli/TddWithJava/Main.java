...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //Por que a JVM nÃ£o "constroi" a classe Main,
        //Por causa disso nÃ£o Ã© invocado o construtor da mesma.
    ...
    public void runProgram(){
        ...
        do {
            System.out.println("Digite um nÃºmero Ã�rabe para converter para Romanos ou 'S' para sair");
            ...
            if (!inputKey.equals(keyToExit))
                System.out.println("Por favor digite um valor vÃ¡lido");
